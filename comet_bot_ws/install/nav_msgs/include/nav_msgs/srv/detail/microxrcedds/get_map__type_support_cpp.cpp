...
#include "nav_msgs/srv/detail/get_map__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _GetMap_Request__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _GetMap_Request__callbacks = {
  ...
  _GetMap_Request__get_serialized_size_with_initial_alignment,
...
{
  return &nav_msgs::srv::typesupport_microxrcedds_cpp::_GetMap_Request__handle;
}
...
static size_t _GetMap_Response__get_serialized_size_with_initial_alignment(
  const void * untyped_ros_message, size_t current_alignment)
{
  auto typed_message =
    static_cast<const nav_msgs::srv::GetMap_Response *>(
...
static message_type_support_callbacks_t _GetMap_Response__callbacks = {
  ...
  _GetMap_Response__get_serialized_size_with_initial_alignment,
...
{
  return &nav_msgs::srv::typesupport_microxrcedds_cpp::_GetMap_Response__handle;
}
...
{
  return &nav_msgs::srv::typesupport_microxrcedds_cpp::_GetMap__handle;
}
