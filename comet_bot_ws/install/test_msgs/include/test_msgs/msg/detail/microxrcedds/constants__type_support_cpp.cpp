...
#include "test_msgs/msg/detail/constants__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _Constants__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _Constants__callbacks = {
  ...
  _Constants__get_serialized_size_with_initial_alignment,
...
{
  return &test_msgs::msg::typesupport_microxrcedds_cpp::_Constants__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, test_msgs, msg, Constants)() {
  return &test_msgs::msg::typesupport_microxrcedds_cpp::_Constants__handle;
}
