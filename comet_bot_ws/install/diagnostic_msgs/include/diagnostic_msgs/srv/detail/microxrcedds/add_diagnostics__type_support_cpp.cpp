...
#include "diagnostic_msgs/srv/detail/add_diagnostics__rosidl_typesupport_microxrcedds_cpp.hpp"
  ...
  ucdrBuffer * cdr)
{
  ...
  rv = ucdr_serialize_string(cdr, ros_message.load_namespace.c_str());
  ...
  diagnostic_msgs::srv::AddDiagnostics_Request & ros_message)
{
  ...
  // Member: load_namespace
  ros_message.load_namespace.resize(ros_message.load_namespace.capacity());
  rv = ucdr_deserialize_string(cdr, &ros_message.load_namespace[0], ros_message.load_namespace.capacity());
  if (rv) {
    ros_message.load_namespace.resize(std::strlen(&ros_message.load_namespace[0]));
  }
...
static size_t _AddDiagnostics_Request__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _AddDiagnostics_Request__callbacks = {
  ...
  _AddDiagnostics_Request__get_serialized_size_with_initial_alignment,
...
{
  return &diagnostic_msgs::srv::typesupport_microxrcedds_cpp::_AddDiagnostics_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, diagnostic_msgs, srv, AddDiagnostics_Request)() {
  return &diagnostic_msgs::srv::typesupport_microxrcedds_cpp::_AddDiagnostics_Request__handle;
}
...
static size_t _AddDiagnostics_Response__get_serialized_size_with_initial_alignment(
  const void * untyped_ros_message, size_t current_alignment)
{
  auto typed_message =
    static_cast<const diagnostic_msgs::srv::AddDiagnostics_Response *>(
...
static message_type_support_callbacks_t _AddDiagnostics_Response__callbacks = {
  ...
  _AddDiagnostics_Response__get_serialized_size_with_initial_alignment,
...
{
  return &diagnostic_msgs::srv::typesupport_microxrcedds_cpp::_AddDiagnostics_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, diagnostic_msgs, srv, AddDiagnostics_Response)() {
  return &diagnostic_msgs::srv::typesupport_microxrcedds_cpp::_AddDiagnostics_Response__handle;
}
...
{
  return &diagnostic_msgs::srv::typesupport_microxrcedds_cpp::_AddDiagnostics__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, diagnostic_msgs, srv, AddDiagnostics)() {
  return &diagnostic_msgs::srv::typesupport_microxrcedds_cpp::_AddDiagnostics__handle;
}
