...
#include "sensor_msgs/msg/detail/laser_echo__rosidl_typesupport_microxrcedds_cpp.hpp"
  ...
  ucdrBuffer * cdr)
{
  ...
  // Member: echoes
  {
    ...
    rv = ucdr_serialize_sequence_float(cdr, &ros_message.echoes[0], size);
  }
  ...
  sensor_msgs::msg::LaserEcho & ros_message)
{
  ...
  // Member: echoes
  {
    ...
    ros_message.echoes.resize(capacity);
    rv = ucdr_deserialize_sequence_float(cdr, &ros_message.echoes[0], capacity, &size);
    if (rv) {
...
static size_t _LaserEcho__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _LaserEcho__callbacks = {
  ...
  _LaserEcho__get_serialized_size_with_initial_alignment,
...
{
  return &sensor_msgs::msg::typesupport_microxrcedds_cpp::_LaserEcho__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, sensor_msgs, msg, LaserEcho)() {
  return &sensor_msgs::msg::typesupport_microxrcedds_cpp::_LaserEcho__handle;
}
