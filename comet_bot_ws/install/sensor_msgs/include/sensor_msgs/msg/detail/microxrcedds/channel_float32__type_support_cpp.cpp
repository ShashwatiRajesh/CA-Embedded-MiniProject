...
#include "sensor_msgs/msg/detail/channel_float32__rosidl_typesupport_microxrcedds_cpp.hpp"
  ...
  ucdrBuffer * cdr)
{
  ...
  // Member: values
  {
    ...
    rv = ucdr_serialize_sequence_float(cdr, &ros_message.values[0], size);
  }
  ...
  sensor_msgs::msg::ChannelFloat32 & ros_message)
{
  ...
  // Member: values
  {
    ...
    ros_message.values.resize(capacity);
    rv = ucdr_deserialize_sequence_float(cdr, &ros_message.values[0], capacity, &size);
    if (rv) {
...
static size_t _ChannelFloat32__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _ChannelFloat32__callbacks = {
  ...
  _ChannelFloat32__get_serialized_size_with_initial_alignment,
...
{
  return &sensor_msgs::msg::typesupport_microxrcedds_cpp::_ChannelFloat32__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, sensor_msgs, msg, ChannelFloat32)() {
  return &sensor_msgs::msg::typesupport_microxrcedds_cpp::_ChannelFloat32__handle;
}
