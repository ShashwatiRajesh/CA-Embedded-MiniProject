...
#include "sensor_msgs/msg/detail/illuminance__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _Illuminance__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _Illuminance__callbacks = {
  ...
  _Illuminance__get_serialized_size_with_initial_alignment,
...
{
  return &sensor_msgs::msg::typesupport_microxrcedds_cpp::_Illuminance__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, sensor_msgs, msg, Illuminance)() {
  return &sensor_msgs::msg::typesupport_microxrcedds_cpp::_Illuminance__handle;
}
