...
#include "example_interfaces/msg/detail/float32_multi_array__rosidl_typesupport_microxrcedds_cpp.hpp"
  ...
  ucdrBuffer * cdr)
{
  ...
  // Member: data
  {
    ...
    rv = ucdr_serialize_sequence_float(cdr, &ros_message.data[0], size);
  }
  ...
  example_interfaces::msg::Float32MultiArray & ros_message)
{
  ...
  // Member: data
  {
    ...
    rv = ucdr_deserialize_sequence_float(cdr, &ros_message.data[0], capacity, &size);
    if (rv) {
...
static size_t _Float32MultiArray__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _Float32MultiArray__callbacks = {
  ...
  _Float32MultiArray__get_serialized_size_with_initial_alignment,
...
{
  return &example_interfaces::msg::typesupport_microxrcedds_cpp::_Float32MultiArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, example_interfaces, msg, Float32MultiArray)() {
  return &example_interfaces::msg::typesupport_microxrcedds_cpp::_Float32MultiArray__handle;
}
