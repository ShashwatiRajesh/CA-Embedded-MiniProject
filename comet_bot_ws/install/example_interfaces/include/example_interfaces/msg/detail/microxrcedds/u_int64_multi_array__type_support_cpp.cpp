...
#include "example_interfaces/msg/detail/u_int64_multi_array__rosidl_typesupport_microxrcedds_cpp.hpp"
  ...
  ucdrBuffer * cdr)
{
  ...
  // Member: data
  {
    ...
    rv = ucdr_serialize_sequence_uint64_t(cdr, &ros_message.data[0], size);
  }
  ...
  example_interfaces::msg::UInt64MultiArray & ros_message)
{
  ...
  // Member: data
  {
    ...
    rv = ucdr_deserialize_sequence_uint64_t(cdr, &ros_message.data[0], capacity, &size);
    if (rv) {
...
static size_t _UInt64MultiArray__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _UInt64MultiArray__callbacks = {
  ...
  _UInt64MultiArray__get_serialized_size_with_initial_alignment,
...
{
  return &example_interfaces::msg::typesupport_microxrcedds_cpp::_UInt64MultiArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, example_interfaces, msg, UInt64MultiArray)() {
  return &example_interfaces::msg::typesupport_microxrcedds_cpp::_UInt64MultiArray__handle;
}
