...
#include "example_interfaces/msg/detail/bool__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _Bool__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _Bool__callbacks = {
  ...
  _Bool__get_serialized_size_with_initial_alignment,
...
{
  return &example_interfaces::msg::typesupport_microxrcedds_cpp::_Bool__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, example_interfaces, msg, Bool)() {
  return &example_interfaces::msg::typesupport_microxrcedds_cpp::_Bool__handle;
}
