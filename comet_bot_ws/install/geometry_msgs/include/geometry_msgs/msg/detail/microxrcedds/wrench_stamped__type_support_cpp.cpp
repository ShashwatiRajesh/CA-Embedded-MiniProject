...
#include "geometry_msgs/msg/detail/wrench_stamped__rosidl_typesupport_microxrcedds_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  *full_bounded = true;
  ...
  current_alignment += std_msgs::msg::typesupport_microxrcedds_cpp::max_serialized_size_Header(
    ...
    current_alignment);
  // Member: wrench
  current_alignment += geometry_msgs::msg::typesupport_microxrcedds_cpp::max_serialized_size_Wrench(
    full_bounded,
    current_alignment);
...
static size_t _WrenchStamped__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _WrenchStamped__callbacks = {
  ...
  _WrenchStamped__get_serialized_size_with_initial_alignment,
...
{
  return &geometry_msgs::msg::typesupport_microxrcedds_cpp::_WrenchStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, geometry_msgs, msg, WrenchStamped)() {
  return &geometry_msgs::msg::typesupport_microxrcedds_cpp::_WrenchStamped__handle;
}
