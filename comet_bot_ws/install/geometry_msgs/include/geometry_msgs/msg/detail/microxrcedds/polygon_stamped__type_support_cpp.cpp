...
#include "geometry_msgs/msg/detail/polygon_stamped__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _PolygonStamped__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _PolygonStamped__callbacks = {
  ...
  _PolygonStamped__get_serialized_size_with_initial_alignment,
...
{
  return &geometry_msgs::msg::typesupport_microxrcedds_cpp::_PolygonStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, geometry_msgs, msg, PolygonStamped)() {
  return &geometry_msgs::msg::typesupport_microxrcedds_cpp::_PolygonStamped__handle;
}
