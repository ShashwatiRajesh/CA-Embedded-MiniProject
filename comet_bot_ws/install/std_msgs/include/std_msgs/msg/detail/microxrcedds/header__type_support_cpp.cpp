...
#include "std_msgs/msg/detail/header__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _Header__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _Header__callbacks = {
  ...
  _Header__get_serialized_size_with_initial_alignment,
...
{
  return &std_msgs::msg::typesupport_microxrcedds_cpp::_Header__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, std_msgs, msg, Header)() {
  return &std_msgs::msg::typesupport_microxrcedds_cpp::_Header__handle;
}
