...
#include "lifecycle_msgs/msg/detail/state__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _State__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _State__callbacks = {
  ...
  _State__get_serialized_size_with_initial_alignment,
...
{
  return &lifecycle_msgs::msg::typesupport_microxrcedds_cpp::_State__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, lifecycle_msgs, msg, State)() {
  return &lifecycle_msgs::msg::typesupport_microxrcedds_cpp::_State__handle;
}
