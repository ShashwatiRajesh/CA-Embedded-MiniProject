...
#include "sensor_msgs/msg/detail/time_reference__rosidl_typesupport_microxrcedds_cpp.hpp"
  ...
  ucdrBuffer * cdr)
{
  ...
  rv = builtin_interfaces::msg::typesupport_microxrcedds_cpp::cdr_serialize(
    ...
    cdr);
  // Member: source
  rv = ucdr_serialize_string(cdr, ros_message.source.c_str());
  ...
  sensor_msgs::msg::TimeReference & ros_message)
{
  ...
  rv = builtin_interfaces::msg::typesupport_microxrcedds_cpp::cdr_deserialize(
    ...
    ros_message.time_ref);
  // Member: source
  ros_message.source.resize(ros_message.source.capacity());
  rv = ucdr_deserialize_string(cdr, &ros_message.source[0], ros_message.source.capacity());
  if (rv) {
    ros_message.source.resize(std::strlen(&ros_message.source[0]));
  }
...
static size_t _TimeReference__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _TimeReference__callbacks = {
  ...
  _TimeReference__get_serialized_size_with_initial_alignment,
...
{
  return &sensor_msgs::msg::typesupport_microxrcedds_cpp::_TimeReference__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, sensor_msgs, msg, TimeReference)() {
  return &sensor_msgs::msg::typesupport_microxrcedds_cpp::_TimeReference__handle;
}
