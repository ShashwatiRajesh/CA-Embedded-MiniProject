...
#include "sensor_msgs/msg/detail/laser_scan__rosidl_typesupport_microxrcedds_cpp.hpp"
  ...
  ucdrBuffer * cdr)
{
  ...
  // Member: ranges
  {
    ...
    rv = ucdr_serialize_sequence_float(cdr, &ros_message.ranges[0], size);
  }
  // Member: intensities
  {
    size_t size = ros_message.intensities.size();
    rv = ucdr_serialize_sequence_float(cdr, &ros_message.intensities[0], size);
  }
  ...
  sensor_msgs::msg::LaserScan & ros_message)
{
  ...
  // Member: ranges
  {
    ...
    ros_message.ranges.resize(capacity);
    rv = ucdr_deserialize_sequence_float(cdr, &ros_message.ranges[0], capacity, &size);
    if (rv) {
  ...
  // Member: intensities
  {
    ...
    ros_message.intensities.resize(capacity);
    rv = ucdr_deserialize_sequence_float(cdr, &ros_message.intensities[0], capacity, &size);
    if (rv) {
...
static size_t _LaserScan__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _LaserScan__callbacks = {
  ...
  _LaserScan__get_serialized_size_with_initial_alignment,
...
{
  return &sensor_msgs::msg::typesupport_microxrcedds_cpp::_LaserScan__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, sensor_msgs, msg, LaserScan)() {
  return &sensor_msgs::msg::typesupport_microxrcedds_cpp::_LaserScan__handle;
}
