...
#include "actionlib_msgs/msg/detail/goal_status_array__rosidl_typesupport_microxrcedds_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member is abstractsequence
    ...
    for (size_t i = 0; i < sequence_size; i++) {
      const size_t item_size = actionlib_msgs::msg::typesupport_microxrcedds_cpp::get_serialized_size(
        ros_message.status_list[i],
        current_alignment);
...
{
  return &actionlib_msgs::msg::typesupport_microxrcedds_cpp::_GoalStatusArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, actionlib_msgs, msg, GoalStatusArray)() {
  return &actionlib_msgs::msg::typesupport_microxrcedds_cpp::_GoalStatusArray__handle;
}
