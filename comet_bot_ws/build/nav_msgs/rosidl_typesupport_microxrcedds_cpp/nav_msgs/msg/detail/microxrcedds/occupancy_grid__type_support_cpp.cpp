...
#include "nav_msgs/msg/detail/occupancy_grid__rosidl_typesupport_microxrcedds_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  *full_bounded = true;
  ...
  current_alignment += std_msgs::msg::typesupport_microxrcedds_cpp::max_serialized_size_Header(
    ...
    current_alignment);
  // Member: info
  current_alignment += nav_msgs::msg::typesupport_microxrcedds_cpp::max_serialized_size_MapMetaData(
    full_bounded,
    current_alignment);
  // Member: data
  {
...
static size_t _OccupancyGrid__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _OccupancyGrid__callbacks = {
  ...
  _OccupancyGrid__get_serialized_size_with_initial_alignment,
...
{
  return &nav_msgs::msg::typesupport_microxrcedds_cpp::_OccupancyGrid__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, nav_msgs, msg, OccupancyGrid)() {
  return &nav_msgs::msg::typesupport_microxrcedds_cpp::_OccupancyGrid__handle;
}
