...
#include "example_interfaces/msg/detail/int64_multi_array__rosidl_typesupport_microxrcedds_cpp.hpp"
  ...
  ucdrBuffer * cdr)
{
  ...
  // Member: data
  {
    ...
    rv = ucdr_serialize_sequence_int64_t(cdr, &ros_message.data[0], size);
  }
  ...
  example_interfaces::msg::Int64MultiArray & ros_message)
{
  ...
  // Member: data
  {
    ...
    rv = ucdr_deserialize_sequence_int64_t(cdr, &ros_message.data[0], capacity, &size);
    if (rv) {
...
static size_t _Int64MultiArray__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _Int64MultiArray__callbacks = {
  ...
  _Int64MultiArray__get_serialized_size_with_initial_alignment,
...
{
  return &example_interfaces::msg::typesupport_microxrcedds_cpp::_Int64MultiArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, example_interfaces, msg, Int64MultiArray)() {
  return &example_interfaces::msg::typesupport_microxrcedds_cpp::_Int64MultiArray__handle;
}
