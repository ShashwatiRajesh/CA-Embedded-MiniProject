...
#include "geometry_msgs/msg/detail/point__rosidl_typesupport_microxrcedds_cpp.hpp"
...
static size_t _Point__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _Point__callbacks = {
  ...
  _Point__get_serialized_size_with_initial_alignment,
...
{
  return &geometry_msgs::msg::typesupport_microxrcedds_cpp::_Point__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, geometry_msgs, msg, Point)() {
  return &geometry_msgs::msg::typesupport_microxrcedds_cpp::_Point__handle;
}
