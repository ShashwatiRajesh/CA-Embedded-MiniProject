...
#include "geometry_msgs/msg/detail/accel_with_covariance_stamped__rosidl_typesupport_microxrcedds_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  *full_bounded = true;
  ...
  current_alignment += std_msgs::msg::typesupport_microxrcedds_cpp::max_serialized_size_Header(
    ...
    current_alignment);
  // Member: accel
  current_alignment += geometry_msgs::msg::typesupport_microxrcedds_cpp::max_serialized_size_AccelWithCovariance(
    full_bounded,
    current_alignment);
...
static size_t _AccelWithCovarianceStamped__get_serialized_size_with_initial_alignment(
...
static message_type_support_callbacks_t _AccelWithCovarianceStamped__callbacks = {
  ...
  _AccelWithCovarianceStamped__get_serialized_size_with_initial_alignment,
...
{
  return &geometry_msgs::msg::typesupport_microxrcedds_cpp::_AccelWithCovarianceStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, geometry_msgs, msg, AccelWithCovarianceStamped)() {
  return &geometry_msgs::msg::typesupport_microxrcedds_cpp::_AccelWithCovarianceStamped__handle;
}
